...
player_one_rounds = 1
player_two_rounds = 1
player_three_rounds = 1
player_four_rounds = 1
...
print('Počet hodů: Hráč 1: ', player_one_rounds - 1, ', Hráč 2: ', player_two_rounds, ', Hráč 3: ', player_three_rounds, ', Hráč 4: ', player_four_rounds)
